...
const orderNoteSchema = z.object({
  ...
  amcosName: z.string().optional(),
  collectionPoint: z.string().optional(),
  distanceKm: z.coerce.number().optional(),
  fuelRatePerKm: z.coerce.number().optional(),
  fuelCurrency: z.string().optional(),
    ...
    .upsert(
      {
        ...
        amcos_name: payload.data.amcosName ?? null,
        collection_point: payload.data.collectionPoint ?? null,
        distance_km: payload.data.distanceKm ?? null,
        fuel_rate_per_km: payload.data.fuelRatePerKm ?? null,
        fuel_currency: payload.data.fuelCurrency ?? "TZS",
